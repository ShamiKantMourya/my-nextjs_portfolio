...
const About = () => {
  ...
  const skills = [
    ...
    },
    {
      name: "Backend",
      icon: <FiServer />,
      items: ["Node.js", "Express", "MongoDB", "GraphQL", "SQL"],
    },
    {
      name: "Design",
      icon: <FiLayers />,
      items: ["Figma", "Responsive Design", "UI/UX", "Wireframing"],
    },
    {
      name: "Tools",
      icon: <FiTool />,
      items: ["Git", "Jest", "Docker", "CI/CD", "Webpack"],
    },
  ];
        ...
        >
          ...
          >
            ...
            >
              ...
              across the entire stack, with a strong focus on React, Next.js,
              Node.js, and modern front-end development practices.
            </motion.p>
            ...
            >
              My passion is creating efficient, scalable, and user-friendly
              applications that solve real-world problems. I'm constantly
              learning new technologies and methodologies to improve my skills
